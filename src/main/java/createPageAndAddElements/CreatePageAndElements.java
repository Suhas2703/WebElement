			...
			String locator1, String value1, String locator2, String value2) throws Exception 
	{
		...
		catch(Exception e)
		{
			...
			if(parentPage.contains("Create Page"))
			{
				...
				util.selectByValue(driver.findElement(By.xpath("(//select[@formcontrolname='Type'])[1]")), "Web");

				//Enter pageName
				wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//input[@placeholder='Page Name'])[1]")));
				driver.findElement(By.xpath("(//input[@placeholder='Page Name'])[1]")).sendKeys(newPageName);
